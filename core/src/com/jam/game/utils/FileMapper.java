...
public class FileMapper {
	...
	public static final Tuple[] sounds = {
			...
			new Tuple("splash_screen", "sounds/splash_screen.mp3"),
			...
			new Tuple("gameplay_music_2", "sounds/gameplay_music_2.mp3"),
	...
	public static final Tuple[] screens = {
			new Tuple("intro_splash", "screens/splash_screen.png"),
			...
			new Tuple("pause_screen", "screens/pause_screen.png"),
